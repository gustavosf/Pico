...
/** \brief Estrutura de dados que implementa uma instrucao TAC
 * Estrutura de dados (que implementa uma intrucao TAC), a ser
 * encadeada na lista.
 */
struct tac {
   char* op;   /* "+", "-", ":=", "if", etc... */
...
/** \brief Elemento básico da lista encadeada
